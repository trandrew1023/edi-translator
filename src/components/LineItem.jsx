...
function LineItem({
  ...
  return (
    <Box>
      <Button variant='text' onClick={handleLineItemCollapse} startIcon={open ? <KeyboardArrowDown /> : <KeyboardArrowRight />}>{`Line Item: ${index + 1} (${lineItem.item})`}</Button>
      <Collapse in={open} sx={{paddingTop: '10px'}} timeout="auto" unmountOnExit>
